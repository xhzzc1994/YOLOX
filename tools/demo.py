...
def make_parser():
    ...
    parser.add_argument(
        "--conf", default=None, type=float, help="test conf"
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    # 处理多个数据来源
    args = make_parser().parse_args()
    args.path = '/home/zzc/DKZN/test_videos/202006231202.mp4'
    args.device = 'gpu'
    args.conf = 0.3
    args.name = 'yolox-m'
    args.ckpt = '/home/zzc/DKZN/MDect/Yolox/YOLOX/YOLOX_outputs/yolox_m_LG_3_continue_finished/latest_ckpt.pth'
    args.nms = 0.5
    args.tsize = 640
    args.save_result = True
    print(args)
    ...
    # python3 tools/demo.py image -n yolox-s -c /home/zzc/DKZN/MDect/Yolox/YOLOX/YOLOX_outputs/yolox_voc_s_UA-DETRAC_yolox_s/latest_ckpt.pth --path /home/zzc/DKZN/test_videos/Picture/1.bmp --conf 0.3 --nms 0.5 --tsize 640 --save_result --device [gpu]
    ##### 使用视频进行测试 #####
    ...
    # python3 tools/demo.py video -n yolox-s -c /home/zzc/DKZN/MDect/Yolox/YOLOX/YOLOX_outputs/yolox_m_LG_3_continue_finished/latest_ckpt.pth --path /home/zzc/DKZN/test_videos/202006231202.mp4 --conf 0.3 --nms 0.5 --tsize 640 --save_result --device [gpu]
